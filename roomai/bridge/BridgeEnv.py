...
class BridgeEnv(roomai.common.AbstractEnv):
    ...
    def init(self, params = dict()):
        ...
        logger.info("param_backward_enable = %s" % (str(self.public_state.param_backward_enable)))
        ...
        logger.info("param_num_normal_players is always %d" % (self.public_state.param_num_normal_players))
