...
if __name__ == "__main__":
    ...
    num        = 0
    for i in range(10000):
        scores = KuhnPokerEnv.compete_silent(env, [player, player_random])
    ...
    num        = 0
    for i in range(10000):
        scores = KuhnPokerEnv.compete_silent(env, [player, player_alwaysbet])
        sum_scores[0] += scores[0]
        sum_scores[1] += scores[1]
        num           += 1
    for i in range(len(sum_scores)):
    ...
    num = 0
    for i in range(10000):
        scores = KuhnPokerEnv.compete_silent(env, [player_random, player_alwaysbet])
        sum_scores[0] += scores[0]
        sum_scores[1] += scores[1]
        num += 1
    for i in range(len(sum_scores)):
